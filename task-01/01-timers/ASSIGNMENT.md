...
If you do not find timers interesting enough, do the same assignment
with any other information source of similar type (for example, the
amount of available system memory, the network traffic volume, and
so on). The most interesting choice will get a bonus point.
