...
As a rule, always write a brief report about what you did in a `SOLUTION.md` file or in the solution notebook.
...
Carefully disclose any use of online resources, including artificial intelligence.
...
The solutions are graded primarily shortly before the next class,
which this year means every second Monday. The grading result
will be in a file called `GRADING.md` in the corresponding
`task` directory.

Grading may be contingent on explanation or clarification.
